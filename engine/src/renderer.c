...
static void renderer_update_vdb_world_gen_descriptor_sets(void) {
  ...
  VkDescriptorBufferInfo vdb_layer_descriptor_buffer_info[] = {
    {
      .offset = 0,
      .buffer = g_vdb.layer_buffer.handle,
      .range = VK_WHOLE_SIZE,
    },
  };
  VkDescriptorImageInfo *vdb_brick_descriptor_image_info = (VkDescriptorImageInfo *)HEAP_ALLOC(sizeof(VkDescriptorImageInfo) * VDB_BRICK_COUNT * VDB_LOD_COUNT_PLUS_ONE, 0, 0);
  ...
  VkWriteDescriptorSet write_descriptor_set[] = {
    {
      ...
      .dstArrayElement = 0,
      .descriptorType = VK_DESCRIPTOR_TYPE_UNIFORM_BUFFER,
      .descriptorCount = ARRAY_COUNT(vdb_info_descriptor_buffer_info),
      .pImageInfo = 0,
      .pBufferInfo = vdb_info_descriptor_buffer_info,
      .pTexelBufferView = 0,
    },
    {
      .sType = VK_STRUCTURE_TYPE_WRITE_DESCRIPTOR_SET,
      ...
      .dstArrayElement = 0,
      .descriptorType = VK_DESCRIPTOR_TYPE_UNIFORM_BUFFER,
      .descriptorCount = ARRAY_COUNT(vdb_layer_descriptor_buffer_info),
      .pImageInfo = 0,
      .pBufferInfo = vdb_layer_descriptor_buffer_info,
      .pTexelBufferView = 0,
    },
    {
      .sType = VK_STRUCTURE_TYPE_WRITE_DESCRIPTOR_SET,
...
static void renderer_update_vdb_soft_renderer_descriptor_sets(void) {
  ...
  while (brick_index < brick_count) {
    ...
    while (lod_index < lod_count) {
      ...
      vdb_brick_descriptor_image_info[descriptor_index].sampler = g_vdb.brick_sampler;
      vdb_brick_descriptor_image_info[descriptor_index].imageView = g_vdb.brick[brick_index].image_view[lod_index];
      vdb_brick_descriptor_image_info[descriptor_index].imageLayout = VK_IMAGE_LAYOUT_GENERAL;
...
static void renderer_record_compute_commands(void) {
  ...
  if (g_renderer.rebuild_lod) {
    ...
    renderer_compute_lod(7);
    renderer_compute_lod(8);
  }
}
static void renderer_record_graphics_commands(void) {
