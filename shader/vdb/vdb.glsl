...
bool vdb_voxel_is_solid(int lod, ivec3 index) {
...
void vdb_voxel_set(int lod, ivec3 index) {
	int i = vdb_voxel_index(lod, index);
...
void vdb_voxel_clr(int lod, ivec3 index) {
	int i = vdb_voxel_index(lod, index);
...
float vdb_voxel_ao(int lod, ivec3 p, ivec3 s1, ivec3 s2, ivec3 c) {
	int o1 = int(vdb_voxel_is_solid(lod, p + s1));
	int o2 = int(vdb_voxel_is_solid(lod, p + s2));
	int oc = int(vdb_voxel_is_solid(lod, p + c));
